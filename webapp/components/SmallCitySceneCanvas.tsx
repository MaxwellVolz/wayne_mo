...
import SmallCityModelWrapper from './SmallCityModelWrapper'
...
/**
 * Small City Three.js scene container
 * Sets up camera, lighting, and controls for the small city map
 */
const SmallCitySceneCanvas = React.memo(function SmallCitySceneCanvas({
  taxisRef,
  deliveriesRef,
  pickupNodesRef,
  deliveryTimerRef,
  ...
  return (
    ...
    >
      ...
      {/* Small City Blender model (buildings and path nodes) */}
      <SmallCityModelWrapper />
...
export default SmallCitySceneCanvas
